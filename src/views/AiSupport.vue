...
.glass-card {
  ...
  overflow: hidden; /* Ensures purple header stays inside rounded corners */
}
...
.status-text { font-size: 11px; color: #dfe6e9; margin: 0; }

/* TOGGLE SWITCH CSS */
.mode-toggle { display: flex; flex-direction: column; align-items: flex-end; gap: 4px; }
.mode-label { font-size: 9px; text-transform: uppercase; font-weight: bold; color: #dfe6e9; }
...
input:checked + .slider { background-color: #a29bfe; } /* Lighter purple when checked */
...
.user .bubble { background: #6c5ce7; color: white; border-bottom-right-radius: 4px; }
...
.send-btn { background: #6c5ce7; color: white; border: none; width: 38px; height: 38px; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: 0.2s; }
.send-btn:hover { transform: scale(1.05); background: #5649c0; }
